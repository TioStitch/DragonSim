	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if (sender instanceof Player) {
			...
			if (p.hasPermission("dragonsimulator.se")) {
				...
				eoem.setDisplayName(DragonSimulator.getInstance().getConfig().getString("items.summoning-eyer.displayName"));
				eoem.setLore(DragonSimulator.getInstance().getConfig().getStringList("items.summoning-eyer.lore"));
