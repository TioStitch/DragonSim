...
public class CustomItems {
	...
	public static HashMap<String, ItemStack> dragonarmor = new HashMap<>();
	...
	private static DragonSet createDragonSet(String type, EnderDragonType edtype) {
		...
		String displaynameHelmet = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".helmet.name");
		String textureHelmet = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".helmet.texture");
		List<String> loreHelmet = DragonSimulator.getItemCfg().getStringList("set." + type.toLowerCase() + ".helmet.lore");

		String displaynameChest = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".chestplate.name");
		String colorChest = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".chestplate.color");
		List<String> loreChest = DragonSimulator.getItemCfg().getStringList("set." + type.toLowerCase() + ".chestplate.lore");

		String displaynameLeggs = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".leggings.name");
		String colorLeggs = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".leggings.color");
		List<String> loreLeggs = DragonSimulator.getItemCfg().getStringList("set." + type.toLowerCase() + ".leggings.lore");

		String displaynameBoots = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".boots.name");
		String colorBoots = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".boots.color");
		List<String> loreBoots = DragonSimulator.getItemCfg().getStringList("set." + type.toLowerCase() + ".boots.lore");

		String displaynameFrag = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".fragment.name");
		String textureFrag = DragonSimulator.getItemCfg().getString("set." + type.toLowerCase() + ".fragment.texture");
		List<String> loreFrag = DragonSimulator.getItemCfg().getStringList("set." + type.toLowerCase() + ".fragment.lore");

		ItemStackUtil fragment = new ItemStackUtil(Material.SKULL_ITEM, displaynameFrag, 1, (byte) 3)
				.setUnbreakable(true)
				.setLore((ArrayList<String>) loreFrag)
				.setTexture(textureFrag);

		ItemStackUtil helmet = new ItemStackUtil(Material.SKULL_ITEM, displaynameHelmet, 1, (byte) 3)
				.setUnbreakable(true)
				.setLore((ArrayList<String>) loreHelmet)
				.setTexture(textureHelmet);

		ItemStackUtil chestplate = new ItemStackUtil(Material.LEATHER_CHESTPLATE, displaynameChest, 1, (byte) 0)
				.setUnbreakable(true)
				.setLore((ArrayList<String>) loreChest)
				.setColor(getColorByString(colorChest));

		ItemStackUtil leggings = new ItemStackUtil(Material.LEATHER_LEGGINGS, displaynameLeggs, 1, (byte) 0)
				.setUnbreakable(true)
				.setLore((ArrayList<String>) loreLeggs)
				.setColor(getColorByString(colorLeggs));

		ItemStackUtil boots = new ItemStackUtil(Material.LEATHER_BOOTS, displaynameBoots, 1, (byte) 0)
				.setUnbreakable(true)
				.setLore((ArrayList<String>) loreBoots)
				.setColor(getColorByString(colorBoots));
...
//
		...
		dragonarmor.put(type.toLowerCase() + "A", helmet.getItem());
		dragonarmor.put(type.toLowerCase() + "B", chestplate.getItem());
		dragonarmor.put(type.toLowerCase() + "C", leggings.getItem());
		dragonarmor.put(type.toLowerCase() + "D", boots.getItem());
